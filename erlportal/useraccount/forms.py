...
#         print('hello')
#         print('world')
#         # file_data = {'image': SimpleUploadedFile(self.cleaned_data['image'])}

#     def save(self, request):
#         user = super().save(request)
#         data =self.cleaned_data
#         # custom processing here
#         profile = Profile(user=user, image=data['image'], firstName=data['firstName'], middleName=data['middleName'], lastName=data['lastName'], phoneNumber=data['phoneNumber'], shareName=data['shareName'], contactPreference=data['contactPreference'], birthDate=data['birthDate'])
#         profile.save()
#         return user
# ProfileFormSet = inlineformset_factory(ErlUser, Profile, form=ProfileCreateForm, extra=2)
