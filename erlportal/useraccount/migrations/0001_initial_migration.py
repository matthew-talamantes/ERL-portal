    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middleName', models.CharField(blank=True, max_length=25, verbose_name='Middle Name')),
                ...
                ('shareName', models.BooleanField(default=False, verbose_name='Share Name')),
                ('contactPreference', models.CharField(choices=[('phone', 'Phone'), ('email', 'E-Mail')], default='email', max_length=5, verbose_name='Contact Preference')),
